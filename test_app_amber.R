...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      div(
        HTML("
          ...
          5-year estimates from <b>2019-2023</b>. This is the most reliable and most recent data available on languages spoken at home in the US. 
    ...
    mainPanel(
      h3("Interactive Map of Locations where Selected Language is Spoken"),
    ...
    maplibre(
      ...
      add_fill_layer(
        ...
        fill_color = interpolate(
          ...
          stops = rev(mako(9)),  # 🔥 Using Viridis! # was magma
          na_color = "lightgrey"
        ),
        fill_opacity = 0.7,
        min_zoom = 8,
      ...
      add_fill_layer(
        ...
        fill_color = interpolate(
          ...
          stops = rev(mako(9)),  # 🔥 Using Viridis!
          na_color = "lightgrey"
        ),
        fill_opacity = 0.7,
        max_zoom = 7.99,
      ...
      add_continuous_legend(
        ...
        values = c(0, 0.5, 1, 2, 5, 10, 20, 30, 50),
        colors = rev(mako(9)),  # 🔥 Using Viridis!
        width = "250px"
      )  
  })
